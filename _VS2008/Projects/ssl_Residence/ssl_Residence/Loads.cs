...
namespace ssl_Residence
{
    ...
    public class SwitchLoad : Load
    {
        ...
        public SwitchLoad(DigitalInputSignal powerFBSignal, DigitalOutputSignal powerOnSignal, DigitalOutputSignal powerOffSignal)
        {
    ...
    public class DimLoad : Load
    {
        ...
        public DimLoad(AnalogInputSignal levelFBSignal, AnalogOutputSignal levelSignal, DigitalOutputSignal raiseSignal, DigitalOutputSignal lowerSignal)
        {
